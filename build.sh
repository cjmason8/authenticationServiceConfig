...
echo "start gradle"
docker run --rm -u gradle -v "/jenkinsHome/workspace/auth-service-pipeline/authService":/home/gradle/project -w /home/gradle/project gradle:8.2-jdk17 gradle -Dskip.tests build
